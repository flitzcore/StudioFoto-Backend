 ...
 *     description: Only admins can create other bookings.
 *     tags: [Bookings]
 *     security:
 *       - bearerAuth: []
 *     requestBody:
 ...
 *     description: Logged in bookings can fetch only their own booking information. Only admins can fetch other bookings.
 *     tags: [Bookings]
 *     security:
 *       - bearerAuth: []
 *     parameters:
 ...
 *     description: Logged in bookings can delete only themselves. Only admins can delete other bookings.
 *     tags: [Bookings]
 *     security:
 *       - bearerAuth: []
 *     parameters:
